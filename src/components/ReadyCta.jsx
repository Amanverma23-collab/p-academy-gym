    ...
    >
      ...
      <div className="max-w-4xl mx-auto flex flex-col items-center justify-center text-center relative z-10">
        ...
        >
          WE'RE READY WHEN
          <br />
          <span className="text-[#facc15] drop-shadow-[0_4px_24px_rgba(250,204,21,0.25)]">
            YOU ARE.
          </span>
        </motion.h2>
        ...
        >
          ...
          <button
            ...
            className="w-full max-w-[280px] sm:max-w-[320px] bg-[#facc15] hover:bg-[#eab308] text-[#081303] font-sans-clean font-black text-xs sm:text-sm tracking-widest uppercase py-4 px-8 rounded-full shadow-lg shadow-[#facc15]/20 hover:scale-105 active:scale-95 transition-all cursor-pointer"
          >
            TRY US FREE
          </button>
          ...
          <a
            ...
            className="w-full max-w-[280px] sm:max-w-[320px] bg-[#091a04]/80 hover:bg-[#facc15] text-[#facc15] hover:text-[#081303] border-2 border-[#facc15] font-sans-clean font-black text-xs sm:text-sm tracking-widest uppercase py-3.5 px-8 rounded-full shadow-md hover:shadow-[#facc15]/20 hover:scale-105 active:scale-95 transition-all inline-flex items-center justify-center cursor-pointer text-center"
          >
            MEMBERSHIP INQUIRY
          </a>
        </motion.div>
